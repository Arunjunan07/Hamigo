      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => ConfirmPageWidget(
            recName: params.getParam('recName', ParamType.String),
            recAddress: params.getParam('recAddress', ParamType.String),
            recPhno: params.getParam('recPhno', ParamType.int),
            sendAddress: params.getParam('sendAddress', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'paymentPage',
