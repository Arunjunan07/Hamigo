...
class ConfirmPageWidget extends StatefulWidget {
  const ConfirmPageWidget({
    ...
    String? recName,
    String? recAddress,
    required this.recPhno,
    required this.sendAddress,
  })  : this.recName = recName ?? 'recipient name',
        this.recAddress = recAddress ?? 'recipient Address',
        super(key: key);
